...
* Archivo modificado por: Pablo Arriola 
* Date: Aug 17, 2010
* @author martin
* 
***********************************/
...
public class TextPanel extends JPanel{
    ...
    public TextPanel(){
        ...
        this.textPane.setFont(new Font("monospaced", Font.PLAIN, 15));
    ...
    private void changePosSelected(){
        ...
        while(!done){
            ...
            if(!to_print_method.isEmpty() && to_print_id.length() != to_print_reserved_1.length() && to_print_id.length() != to_print_reserved_2.length()){
                ...
                this.replaceSytleColor(set, bold, blue, to_print_reserved_1, indice);
                ...
                this.replaceSytleColor(set, bold, dark_green, to_print_reserved_2, indice);
